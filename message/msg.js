/**
         [ CREDITS ]
         * Coding by @riyanz
         * @ YT : https://youtube.com/c/YANZGTZ
         * @ YT CHANNEL : ꪶꫂꬅ꤃ϝᎥґꪜꫂ 🅥 
         * @ WhatsApp : wa.me/6281361283683
  */  
  /**
         [ CREDITS ] || [ THANKS TO ]
         * @rifza.p.p
     ...
     client.DeleteMessage(ah, botNumber)
      ...
      case prefix+'m': case prefix+'menu':{//Rfz XM
           client.sendMessage(from, { react: { text: "⏱️", key: msg.key }})
             ...
             let sourceUrl =  'https://instagram.com/saturnuspediasmm'
             let mediaUrl = 'https://instagram.com/saturnuspediasmm'                            
